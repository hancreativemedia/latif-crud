    ...
    <div class="pb-3">
        ...
        <form action="{{ route('category.update', $category->slug) }}" method="POST" >
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"  value="{{ old('name', $category->name) }}">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" id="slug" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" readonly value="{{ old('slug', $category->slug) }}">
                @error('slug')
                    <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                @enderror
            </div>
